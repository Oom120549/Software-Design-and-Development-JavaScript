...
```
![image](https://github.com/user-attachments/assets/3085fc48-a015-46f9-aa47-2e72116a11b7)
...
<body>
    <script src="java 2.4.1.js"></script>
</body>
</html>
```
...
```
![image](https://github.com/user-attachments/assets/06280592-e387-40d2-80ec-a5d8deff384c)
...
<body>
    <script src="java 2.4.2.js"></script>
</body>
</html>
```
...
const greetUser = (name, age) => {
    return age < 13 ? `สวัสดี ไอน้อง ${name}` :
           age < 20 ? `หวัดดี! วัยรุ่น ${name}` :
                      `สวัสดี คุณ ${name}`;
};

// ทดสอบใช้งาน
console.log(greetUser("สมชาย", 10));
console.log(greetUser("มานะ", 18));
console.log(greetUser("วิชัย", 25));
...
console.log(checkPassword("mypassword123"));
```
![image](https://github.com/user-attachments/assets/5bef4af2-3360-4ee1-a536-444c837cc96c)
...
```
![image](https://github.com/user-attachments/assets/581b3c20-0895-41fd-a6f8-b2a61ba036a3)
...
```
![image](https://github.com/user-attachments/assets/47e9ced5-8717-4d92-8abe-353c6b94b090)

![image](https://github.com/user-attachments/assets/5de6c8ca-d655-4cb2-bed0-de1a7c7490d8)
